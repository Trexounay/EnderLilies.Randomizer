...
// BlueprintGeneratedClass BP_DefaultMediaSound.BP_DefaultMediaSound_C
...
public:
	...
	float                                              VolumeMultiplier;                                          // 0x0238(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_DefaultMediaSound.BP_DefaultMediaSound_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_DefaultMediaSound(int EntryPoint);
};
