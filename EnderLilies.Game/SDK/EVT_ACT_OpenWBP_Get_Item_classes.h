...
// BlueprintGeneratedClass EVT_ACT_OpenWBP_Get_Item.EVT_ACT_OpenWBP_Get_Item_C
// 0x0021 (FullSize[0x0061] - InheritedSize[0x0040])
class UEVT_ACT_OpenWBP_Get_Item_C : public UEventAction
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                            // 0x0040(0x0008) (ZeroConstructor, Transient, DuplicateTransient)
	struct FName                                       ItemBBKey;                                                 // 0x0048(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_36HU[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass EVT_ACT_OpenWBP_Get_Item.EVT_ACT_OpenWBP_Get_Item_C");
		return ptr;
	}



	void OnGameUnpaused_48C8F81840AE488A293540A5A51D14D8();
	...
	void ExecuteUbergraph_EVT_ACT_OpenWBP_Get_Item(int EntryPoint);
};
