...
public:
	...
	bool STATIC_ToggleARCapture(bool bOnOff, AugmentedReality_EARCaptureType CaptureType);
	...
	bool STATIC_SaveARPinToLocalStore(const struct FName& InSaveName, class UARPin* InPin);
	struct FIntPoint STATIC_ResizeXRCamera(const struct FIntPoint& InSize);
	void STATIC_RemovePin(class UARPin* PinToRemove);
	void STATIC_RemoveARPinFromLocalStore(const struct FName& InSaveName);
	...
	TMap<struct FName, class UARPin*> STATIC_LoadARPinsFromLocalStore();
	...
	bool STATIC_IsSceneReconstructionSupported(AugmentedReality_EARSessionType SessionType, AugmentedReality_EARSceneReconstruction SceneReconstructionMethod);
	...
	bool STATIC_GetObjectClassificationAtLocation(const struct FVector& InWorldLocation, AugmentedReality_EARObjectClassification* OutClassification, struct FVector* OutClassificationLocation, float MaxLocationDiff);
	...
	class UARTexture* STATIC_GetARTexture(AugmentedReality_EARTextureType TextureType);
	...
	TArray<class UARTrackedPoint*> STATIC_FindTrackedPointsByName(const struct FString& PointName);
	...
	bool STATIC_AddTrackedPointWithName(const struct FTransform& WorldTransform, const struct FString& PointName, bool bDeletePointsWithSameName);
...
{
public:
	unsigned char                                      UnknownData_TRU8[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_BW0O[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnSuccess;                                                 // 0x0050(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	struct FScriptMulticastDelegate                    OnFailed;                                                  // 0x0060(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_RNHM[0x28];                                    // 0x0070(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_38BX[0x30];                                    // 0x0208(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZP95[0x7];                                     // 0x0239(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G70L[0x20];                                    // 0x0260(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	void STATIC_SetPlaneComponentDebugMode(AugmentedReality_EPlaneComponentDebugMode NewDebugMode);
	void STATIC_SetObjectClassificationDebugColors(TMap<AugmentedReality_EARObjectClassification, struct FLinearColor> InColors);
	...
	TMap<AugmentedReality_EARObjectClassification, struct FLinearColor> STATIC_GetObjectClassificationDebugColors();
};
...
public:
	...
	unsigned char                                      UnknownData_VSJL[0x20];                                    // 0x02C0(0x0020) MISSED OFFSET (PADDING)
	...
	void STATIC_SetFaceComponentDebugMode(AugmentedReality_EFaceComponentDebugMode NewDebugMode);
...
public:
	...
	void STATIC_SetImageComponentDebugMode(AugmentedReality_EImageComponentDebugMode NewDebugMode);
...
public:
	...
	void STATIC_SetQRCodeComponentDebugMode(AugmentedReality_EQRCodeComponentDebugMode NewDebugMode);
...
public:
	...
	void STATIC_SetPoseComponentDebugMode(AugmentedReality_EPoseComponentDebugMode NewDebugMode);
...
public:
	...
	void STATIC_SetGeoAnchorComponentDebugMode(AugmentedReality_EGeoAnchorComponentDebugMode NewDebugMode);
...
public:
	struct FScriptMulticastDelegate                    OnSuccess;                                                 // 0x0050(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	struct FScriptMulticastDelegate                    OnFailed;                                                  // 0x0060(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_0W9G[0x30];                                    // 0x0070(0x0030) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnSuccess;                                                 // 0x0050(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	struct FScriptMulticastDelegate                    OnFailed;                                                  // 0x0060(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_37E0[0x30];                                    // 0x0070(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NE3M[0x18];                                    // 0x0218(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_V40V[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2HQ3[0x1F];                                    // 0x00A1(0x001F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6CK9[0x10];                                    // 0x00E0(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_OU8T[0x2];                                     // 0x0046(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5VM3[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QPBM[0x1];                                     // 0x008F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2UED[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BBBU[0x6];                                     // 0x00AA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_SVQS[0x64];                                    // 0x030C(0x0064) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_96G0[0x8];                                     // 0x02C0(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UWDJ[0x8];                                     // 0x0570(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_1UYD[0x8];                                     // 0x0238(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_B06L[0x3];                                     // 0x00D9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_LE82[0x5];                                     // 0x00FB(0x0005) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YV7X[0x3];                                     // 0x0131(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_MG1X[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HAKN[0xF];                                     // 0x00A1(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9TV2[0x17];                                    // 0x00B9(0x0017) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7XC3[0xC];                                     // 0x00D4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4HK7[0x10];                                    // 0x00E8(0x0010) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_RO8L[0x4];                                     // 0x00F8(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_BNX3[0x4];                                     // 0x0114(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_T2ZU[0x8];                                     // 0x00F8(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_NLAT[0x4];                                     // 0x011C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_P12V[0x3];                                     // 0x0105(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<AugmentedReality_EARFaceBlendShape, float>    BlendShapes;                                               // 0x0108(0x0050) (NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_G3X4[0x38];                                    // 0x0158(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_6FBL[0x4];                                     // 0x0104(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_MGE9[0x8];                                     // 0x0148(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AXTU[0x8];                                     // 0x00F8(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_FQKP[0x8];                                     // 0x00F8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_NOSF[0x10];                                    // 0x0100(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_VK7P[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_HCHG[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
