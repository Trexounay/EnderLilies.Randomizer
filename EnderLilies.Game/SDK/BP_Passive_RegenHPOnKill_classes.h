...
// BlueprintGeneratedClass BP_Passive_RegenHPOnKill.BP_Passive_RegenHPOnKill_C
...
public:
	...
	float                                              MaxHPPercentageRecovery;                                   // 0x0038(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Passive_RegenHPOnKill.BP_Passive_RegenHPOnKill_C");
		return ptr;
	}
	...
	void OnEnemyKilled(class AActor* KilledEnemy);
	void ExecuteUbergraph_BP_Passive_RegenHPOnKill(int EntryPoint);
};
