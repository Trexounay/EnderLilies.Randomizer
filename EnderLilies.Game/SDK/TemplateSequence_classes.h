...
{
public:
	unsigned char                                      UnknownData_K4QV[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BBY7[0x3C];                                    // 0x0034(0x003C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_396Q[0x3];                                     // 0x00B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YAAR[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8QZJ[0x458];                                   // 0x0028(0x0458) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_39PI[0x60];                                    // 0x0578(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XOO1[0x8];                                     // 0x0220(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ME52[0x4];                                     // 0x023C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HJ41[0x4];                                     // 0x026C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QKMA[0x8];                                     // 0x0680(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0F1Y[0x8];                                     // 0x0160(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MZQT[0x70];                                    // 0x0040(0x0070) MISSED OFFSET (PADDING)
