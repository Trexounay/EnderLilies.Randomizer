...
struct FAnimationEventBinding
{
	...
	unsigned char                                      UnknownData_YHDI[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MGYR[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FSlateChildSize
{
	...
	unsigned char                                      UnknownData_1Y5F[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FRadialBoxSettings
{
	...
	unsigned char                                      UnknownData_Y4YK[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FUserWidgetPool
{
	...
	unsigned char                                      UnknownData_D7A7[0x60];                                    // 0x0020(0x0060) MISSED OFFSET (PADDING)
...
struct FWidgetAnimationBinding
{
	...
	unsigned char                                      UnknownData_NQCE[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintWidgetAnimationDelegateBinding
{
	...
	unsigned char                                      UnknownData_18KS[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDelegateRuntimeBinding
{
	...
	unsigned char                                      UnknownData_1M51[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FWidgetNavigationData
{
	...
	unsigned char                                      UnknownData_8YTK[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEventReply
{
	unsigned char                                      UnknownData_AE3J[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7X63[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FMovieSceneMarginSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_VQNI[0x7];                                     // 0x02B9(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GX70[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
