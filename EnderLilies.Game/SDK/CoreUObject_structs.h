...
namespace CG
{
	...
	{
		unsigned char                                      UnknownData_EHYB[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
	...
	struct FBox
	{
		...
		unsigned char                                      UnknownData_8NFU[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
	...
	struct FBox2D
	{
		...
		unsigned char                                      UnknownData_6FIW[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
	...
	struct FInterpCurvePointFloat
	{
		...
		unsigned char                                      UnknownData_SGOC[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
	...
	struct FInterpCurveFloat
	{
		...
		unsigned char                                      UnknownData_TVAP[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FInterpCurvePointVector2D
	{
		...
		unsigned char                                      UnknownData_6EV1[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
	...
	struct FInterpCurveVector2D
	{
		...
		bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		unsigned char                                      UnknownData_L9FK[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FInterpCurvePointVector
	{
		...
		unsigned char                                      UnknownData_LJ8F[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
	...
	struct FInterpCurveVector
	{
		...
		bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		unsigned char                                      UnknownData_PGOG[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	{
		float                                              InVal;                                                     // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		unsigned char                                      UnknownData_ZT3S[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_408C[0xF];                                     // 0x0041(0x000F) MISSED OFFSET (PADDING)
	...
	struct FInterpCurveQuat
	{
		...
		bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		unsigned char                                      UnknownData_3XC6[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FInterpCurvePointTwoVectors
	{
		...
		unsigned char                                      UnknownData_MOZ4[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
	...
	struct FInterpCurveTwoVectors
	{
		...
		bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		unsigned char                                      UnknownData_ABYE[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FInterpCurvePointLinearColor
	{
		...
		unsigned char                                      UnknownData_H2NR[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
	...
	struct FInterpCurveLinearColor
	{
		...
		bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		unsigned char                                      UnknownData_822P[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FTransform
	{
		...
		unsigned char                                      UnknownData_A35W[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_CE9R[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
	...
	struct FDateTime
	{
		unsigned char                                      UnknownData_FH4Y[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
	...
	struct FTimecode
	{
		...
		unsigned char                                      UnknownData_I4Q2[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
	...
	struct FTimespan
	{
		unsigned char                                      UnknownData_2UQZ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
	...
	{
		unsigned char                                      UnknownData_X6ST[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
	...
	struct FFloatRangeBound
	{
		...
		unsigned char                                      UnknownData_ESQO[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		TEnumAsByte<CoreUObject_ERangeBoundTypes>          Type;                                                      // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		unsigned char                                      UnknownData_R3HH[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		TEnumAsByte<CoreUObject_ERangeBoundTypes>          Type;                                                      // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		unsigned char                                      UnknownData_UWQX[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FPolyglotTextData
	{
		...
		unsigned char                                      UnknownData_UF6P[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_7MO6[0x7];                                     // 0x0099(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FAutomationEvent
	{
		...
		unsigned char                                      UnknownData_NC1V[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FAutomationExecutionEntry
	{
		...
		unsigned char                                      UnknownData_2WC9[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FARFilter
	{
		...
		unsigned char                                      UnknownData_37PU[0x50];                                    // 0x0040(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_5BS6[0xD];                                     // 0x00E3(0x000D) MISSED OFFSET (PADDING)
	...
	struct FAssetData
	{
		...
		unsigned char                                      UnknownData_P9HY[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
