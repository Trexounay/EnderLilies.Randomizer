...
public:
	...
	unsigned char                                      UnknownData_WD1D[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GYZI[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (PADDING)
