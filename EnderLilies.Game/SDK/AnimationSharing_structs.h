...
struct FAnimationSetup
{
	...
	unsigned char                                      UnknownData_9FRD[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimationSharingScalability
{
	...
	unsigned char                                      UnknownData_UGRK[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimationStateEntry
{
	...
	unsigned char                                      UnknownData_JX0U[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PM1L[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6BTU[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7QL7[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ELPU[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
