...
// BlueprintGeneratedClass EVT_ACT_FadeOut.EVT_ACT_FadeOut_C
...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass EVT_ACT_FadeOut.EVT_ACT_FadeOut_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_EVT_ACT_FadeOut(int EntryPoint);
};
