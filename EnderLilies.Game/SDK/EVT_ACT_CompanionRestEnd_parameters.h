...
// Function EVT_ACT_CompanionRestEnd.EVT_ACT_CompanionRestEnd_C.UnregisterSpiritCompanion
struct UEVT_ACT_CompanionRestEnd_C_UnregisterSpiritCompanion_Params
{
	...
	struct FName                                       Binding;                                                   // 0x0008(0x0008)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function EVT_ACT_CompanionRestEnd.EVT_ACT_CompanionRestEnd_C.OnStartAction
struct UEVT_ACT_CompanionRestEnd_C_OnStartAction_Params
{
...
// Function EVT_ACT_CompanionRestEnd.EVT_ACT_CompanionRestEnd_C.ExecuteUbergraph_EVT_ACT_CompanionRestEnd
struct UEVT_ACT_CompanionRestEnd_C_ExecuteUbergraph_EVT_ACT_CompanionRestEnd_Params
{
