...
// WidgetBlueprintGeneratedClass WBP_FinalPassiveParts.WBP_FinalPassiveParts_C
// 0x0050 (FullSize[0x02B0] - InheritedSize[0x0260])
class UWBP_FinalPassiveParts_C : public UUserWidget
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                            // 0x0260(0x0008) (ZeroConstructor, Transient, DuplicateTransient)
	class UTextBlock*                                  AttackPower_2;                                             // 0x0268(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UImage*                                      LastPassiveIcon;                                           // 0x02A8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WBP_FinalPassiveParts.WBP_FinalPassiveParts_C");
		return ptr;
	}



	void SetPartVisibility(class UWidget* Target, bool Index);
	void Setup(int PartCount);
	void Construct();
	void ExecuteUbergraph_WBP_FinalPassiveParts(int EntryPoint);
};
